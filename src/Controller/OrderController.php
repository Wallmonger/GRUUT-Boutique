    ...
    public function add(Cart $cart, Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) { 
            ...
            foreach ($cart->getFull() as $product) {
                ...
                $orderDetails->setTotal($product['product']->getPrice() * $product['quantity']);  // IL FAUT AJOUTER L'ID DU PRODUIT POUR LE RECUP 


                // ========================================================
                // Suppression des matériaux dans les stocks 
